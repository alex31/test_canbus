...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_HIGH(PA00) | \
					 PIN_OSPEED_HIGH(PA01) | \
					 PIN_OSPEED_HIGH(PA02) | \
					 PIN_OSPEED_HIGH(PA03) | \
					 PIN_OSPEED_HIGH(PA04) | \
					 PIN_OSPEED_HIGH(PA05) | \
					 PIN_OSPEED_HIGH(PA06) | \
					 PIN_OSPEED_HIGH(PA07) | \
					 PIN_OSPEED_HIGH(PA08) | \
					 PIN_OSPEED_HIGH(PA09) | \
					 PIN_OSPEED_HIGH(PA10) | \
					 PIN_OSPEED_HIGH(PA11) | \
					 PIN_OSPEED_HIGH(PA12) | \
					 PIN_OSPEED_HIGH(PA13_SWDIO) | \
					 PIN_OSPEED_HIGH(PA14_SWCLK) | \
					 PIN_OSPEED_HIGH(PA15))
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LOW(PA00) | \
					 PIN_ODR_LOW(PA01) | \
					 PIN_ODR_LOW(PA02) | \
					 PIN_ODR_LOW(PA03) | \
					 PIN_ODR_LOW(PA04) | \
					 ...
					 PIN_ODR_LOW(PA11) | \
					 PIN_ODR_LOW(PA12) | \
					 PIN_ODR_HIGH(PA13_SWDIO) | \
					 PIN_ODR_HIGH(PA14_SWCLK) | \
					 PIN_ODR_LOW(PA15))
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_HIGH(PB00) | \
					 PIN_OSPEED_HIGH(PB01) | \
					 PIN_OSPEED_HIGH(PB02) | \
					 ...
					 PIN_OSPEED_HIGH(PB11) | \
					 PIN_OSPEED_HIGH(PB12) | \
					 PIN_OSPEED_HIGH(PB13) | \
					 PIN_OSPEED_HIGH(PB14) | \
					 PIN_OSPEED_HIGH(PB15))
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LOW(PB00) | \
					 PIN_ODR_LOW(PB01) | \
					 PIN_ODR_LOW(PB02) | \
					 PIN_ODR_LOW(PB03) | \
					 PIN_ODR_LOW(PB04) | \
...
#define VAL_GPIOC_OSPEEDR               (PIN_OSPEED_HIGH(PC00_LED1) | \
					 ...
					 PIN_OSPEED_HIGH(PC05) | \
					 PIN_OSPEED_HIGH(PC06) | \
					 PIN_OSPEED_HIGH(PC07) | \
					 PIN_OSPEED_HIGH(PC08) | \
					 PIN_OSPEED_HIGH(PC09) | \
					 PIN_OSPEED_HIGH(PC10) | \
					 PIN_OSPEED_HIGH(PC11) | \
					 PIN_OSPEED_HIGH(PC12) | \
					 PIN_OSPEED_HIGH(PC13) | \
					 PIN_OSPEED_HIGH(PC14_OSC32_IN) | \
					 PIN_OSPEED_HIGH(PC15_OSC32_OUT))

#define VAL_GPIOC_PUPDR                 (PIN_PUPDR_FLOATING(PC00_LED1) | \
					 PIN_PUPDR_FLOATING(PC01_SWITCH1) | \
...
#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_HIGH(PD00) | \
					 PIN_OSPEED_HIGH(PD01) | \
					 PIN_OSPEED_HIGH(PD02) | \
					 PIN_OSPEED_HIGH(PD03) | \
					 PIN_OSPEED_HIGH(PD04) | \
					 PIN_OSPEED_HIGH(PD05) | \
					 PIN_OSPEED_HIGH(PD06) | \
					 PIN_OSPEED_HIGH(PD07) | \
					 PIN_OSPEED_HIGH(PD08) | \
					 PIN_OSPEED_HIGH(PD09) | \
					 PIN_OSPEED_HIGH(PD10) | \
					 PIN_OSPEED_HIGH(PD11) | \
					 PIN_OSPEED_HIGH(PD12) | \
					 PIN_OSPEED_HIGH(PD13) | \
					 PIN_OSPEED_HIGH(PD14) | \
					 PIN_OSPEED_HIGH(PD15))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LOW(PD00) | \
					 PIN_ODR_LOW(PD01) | \
					 PIN_ODR_LOW(PD02) | \
					 PIN_ODR_LOW(PD03) | \
					 PIN_ODR_LOW(PD04) | \
...
#define VAL_GPIOE_OSPEEDR               (PIN_OSPEED_HIGH(PE00) | \
					 PIN_OSPEED_HIGH(PE01) | \
					 PIN_OSPEED_HIGH(PE02) | \
					 PIN_OSPEED_HIGH(PE03) | \
					 PIN_OSPEED_HIGH(PE04) | \
					 PIN_OSPEED_HIGH(PE05) | \
					 PIN_OSPEED_HIGH(PE06) | \
					 PIN_OSPEED_HIGH(PE07) | \
					 PIN_OSPEED_HIGH(PE08) | \
					 PIN_OSPEED_HIGH(PE09) | \
					 PIN_OSPEED_HIGH(PE10) | \
					 PIN_OSPEED_HIGH(PE11) | \
					 PIN_OSPEED_HIGH(PE12) | \
					 PIN_OSPEED_HIGH(PE13) | \
					 PIN_OSPEED_HIGH(PE14) | \
					 PIN_OSPEED_HIGH(PE15))
...
#define VAL_GPIOE_ODR                   (PIN_ODR_LOW(PE00) | \
					 PIN_ODR_LOW(PE01) | \
					 PIN_ODR_LOW(PE02) | \
					 PIN_ODR_LOW(PE03) | \
					 PIN_ODR_LOW(PE04) | \
...
#define VAL_GPIOF_OSPEEDR               (PIN_OSPEED_HIGH(PF00) | \
					 PIN_OSPEED_HIGH(PF01) | \
					 PIN_OSPEED_HIGH(PF02) | \
					 PIN_OSPEED_HIGH(PF03) | \
					 PIN_OSPEED_HIGH(PF04) | \
					 PIN_OSPEED_HIGH(PF05) | \
					 PIN_OSPEED_HIGH(PF06) | \
					 PIN_OSPEED_HIGH(PF07) | \
					 PIN_OSPEED_HIGH(PF08) | \
					 PIN_OSPEED_HIGH(PF09) | \
					 PIN_OSPEED_HIGH(PF10) | \
					 PIN_OSPEED_HIGH(PF11) | \
					 PIN_OSPEED_HIGH(PF12) | \
					 PIN_OSPEED_HIGH(PF13) | \
					 PIN_OSPEED_HIGH(PF14) | \
					 PIN_OSPEED_HIGH(PF15))
...
#define VAL_GPIOF_ODR                   (PIN_ODR_LOW(PF00) | \
					 PIN_ODR_LOW(PF01) | \
					 PIN_ODR_LOW(PF02) | \
					 PIN_ODR_LOW(PF03) | \
					 PIN_ODR_LOW(PF04) | \
...
#define VAL_GPIOG_OSPEEDR               (PIN_OSPEED_HIGH(PG00) | \
					 PIN_OSPEED_HIGH(PG01) | \
					 PIN_OSPEED_HIGH(PG02) | \
					 PIN_OSPEED_HIGH(PG03) | \
					 PIN_OSPEED_HIGH(PG04) | \
					 PIN_OSPEED_HIGH(PG05) | \
					 PIN_OSPEED_HIGH(PG06) | \
					 PIN_OSPEED_HIGH(PG07) | \
					 PIN_OSPEED_HIGH(PG08) | \
					 PIN_OSPEED_HIGH(PG09) | \
					 PIN_OSPEED_HIGH(PG10) | \
					 PIN_OSPEED_HIGH(PG11) | \
					 PIN_OSPEED_HIGH(PG12) | \
					 PIN_OSPEED_HIGH(PG13) | \
					 PIN_OSPEED_HIGH(PG14) | \
					 PIN_OSPEED_HIGH(PG15))
...
#define VAL_GPIOG_ODR                   (PIN_ODR_LOW(PG00) | \
					 PIN_ODR_LOW(PG01) | \
					 PIN_ODR_LOW(PG02) | \
					 PIN_ODR_LOW(PG03) | \
					 PIN_ODR_LOW(PG04) | \
...
#define VAL_GPIOH_OSPEEDR               (PIN_OSPEED_HIGH(PH00_OSC_IN) | \
					 PIN_OSPEED_HIGH(PH01_OSC_OUT) | \
					 PIN_OSPEED_HIGH(PH02) | \
					 PIN_OSPEED_HIGH(PH03) | \
					 PIN_OSPEED_HIGH(PH04) | \
					 PIN_OSPEED_HIGH(PH05) | \
					 PIN_OSPEED_HIGH(PH06) | \
					 PIN_OSPEED_HIGH(PH07) | \
					 PIN_OSPEED_HIGH(PH08) | \
					 PIN_OSPEED_HIGH(PH09) | \
					 PIN_OSPEED_HIGH(PH10) | \
					 PIN_OSPEED_HIGH(PH11) | \
					 PIN_OSPEED_HIGH(PH12) | \
					 PIN_OSPEED_HIGH(PH13) | \
					 PIN_OSPEED_HIGH(PH14) | \
					 PIN_OSPEED_HIGH(PH15))
...
#define VAL_GPIOH_ODR                   (PIN_ODR_HIGH(PH00_OSC_IN) | \
					 PIN_ODR_HIGH(PH01_OSC_OUT) | \
					 PIN_ODR_LOW(PH02) | \
					 PIN_ODR_LOW(PH03) | \
					 PIN_ODR_LOW(PH04) | \
					 PIN_ODR_LOW(PH05) | \
...
#define VAL_GPIOI_OSPEEDR               (PIN_OSPEED_HIGH(PI00) | \
					 PIN_OSPEED_HIGH(PI01) | \
					 PIN_OSPEED_HIGH(PI02) | \
					 PIN_OSPEED_HIGH(PI03) | \
					 PIN_OSPEED_HIGH(PI04) | \
					 PIN_OSPEED_HIGH(PI05) | \
					 PIN_OSPEED_HIGH(PI06) | \
					 PIN_OSPEED_HIGH(PI07) | \
					 PIN_OSPEED_HIGH(PI08) | \
					 PIN_OSPEED_HIGH(PI09) | \
					 PIN_OSPEED_HIGH(PI10) | \
					 PIN_OSPEED_HIGH(PI11) | \
					 PIN_OSPEED_HIGH(PI12) | \
					 PIN_OSPEED_HIGH(PI13) | \
					 PIN_OSPEED_HIGH(PI14) | \
					 PIN_OSPEED_HIGH(PI15))
...
#define VAL_GPIOI_ODR                   (PIN_ODR_LOW(PI00) | \
					 PIN_ODR_LOW(PI01) | \
					 PIN_ODR_LOW(PI02) | \
					 PIN_ODR_LOW(PI03) | \
					 PIN_ODR_LOW(PI04) | \
...
#define VAL_GPIOJ_OSPEEDR               (PIN_OSPEED_HIGH(PJ00) | \
					 PIN_OSPEED_HIGH(PJ01) | \
					 PIN_OSPEED_HIGH(PJ02) | \
					 PIN_OSPEED_HIGH(PJ03) | \
					 PIN_OSPEED_HIGH(PJ04) | \
					 PIN_OSPEED_HIGH(PJ05) | \
					 PIN_OSPEED_HIGH(PJ06) | \
					 PIN_OSPEED_HIGH(PJ07) | \
					 PIN_OSPEED_HIGH(PJ08) | \
					 PIN_OSPEED_HIGH(PJ09) | \
					 PIN_OSPEED_HIGH(PJ10) | \
					 PIN_OSPEED_HIGH(PJ11) | \
					 PIN_OSPEED_HIGH(PJ12) | \
					 PIN_OSPEED_HIGH(PJ13) | \
					 PIN_OSPEED_HIGH(PJ14) | \
					 PIN_OSPEED_HIGH(PJ15))
...
#define VAL_GPIOJ_ODR                   (PIN_ODR_LOW(PJ00) | \
					 PIN_ODR_LOW(PJ01) | \
					 PIN_ODR_LOW(PJ02) | \
					 PIN_ODR_LOW(PJ03) | \
					 PIN_ODR_LOW(PJ04) | \
...
#define VAL_GPIOK_OSPEEDR               (PIN_OSPEED_HIGH(PK00) | \
					 PIN_OSPEED_HIGH(PK01) | \
					 PIN_OSPEED_HIGH(PK02) | \
					 PIN_OSPEED_HIGH(PK03) | \
					 PIN_OSPEED_HIGH(PK04) | \
					 PIN_OSPEED_HIGH(PK05) | \
					 PIN_OSPEED_HIGH(PK06) | \
					 PIN_OSPEED_HIGH(PK07) | \
					 PIN_OSPEED_HIGH(PK08) | \
					 PIN_OSPEED_HIGH(PK09) | \
					 PIN_OSPEED_HIGH(PK10) | \
					 PIN_OSPEED_HIGH(PK11) | \
					 PIN_OSPEED_HIGH(PK12) | \
					 PIN_OSPEED_HIGH(PK13) | \
					 PIN_OSPEED_HIGH(PK14) | \
					 PIN_OSPEED_HIGH(PK15))
...
#define VAL_GPIOK_ODR                   (PIN_ODR_LOW(PK00) | \
					 PIN_ODR_LOW(PK01) | \
					 PIN_ODR_LOW(PK02) | \
					 PIN_ODR_LOW(PK03) | \
					 PIN_ODR_LOW(PK04) | \
