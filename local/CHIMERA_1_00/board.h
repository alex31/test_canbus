...
#define VAL_GPIOA_MODER                 (PIN_MODE_INPUT(AUX3) | \
					 PIN_MODE_ALTERNATE(RC1_UART4_RX) | \
					 PIN_MODE_INPUT(AUX2) | \
					 PIN_MODE_INPUT(AUX1) | \
					 PIN_MODE_ANALOG(VBAT_MEAS) | \
					 PIN_MODE_ANALOG(AUX0) | \
					 PIN_MODE_ALTERNATE(SRV0_TIM3_CH1) | \
					 PIN_MODE_ALTERNATE(SRV1_TIM3_CH2) | \
...
#define VAL_GPIOA_OTYPER                (PIN_OTYPE_OPENDRAIN(AUX3) | \
					 PIN_OTYPE_PUSHPULL(RC1_UART4_RX) | \
					 PIN_OTYPE_OPENDRAIN(AUX2) | \
					 PIN_OTYPE_OPENDRAIN(AUX1) | \
					 PIN_OTYPE_PUSHPULL(VBAT_MEAS) | \
					 PIN_OTYPE_PUSHPULL(AUX0) | \
					 PIN_OTYPE_PUSHPULL(SRV0_TIM3_CH1) | \
					 PIN_OTYPE_PUSHPULL(SRV1_TIM3_CH2) | \
...
#define VAL_GPIOA_OSPEEDR               (PIN_OSPEED_SPEED_VERYLOW(AUX3) | \
					 PIN_OSPEED_SPEED_HIGH(RC1_UART4_RX) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(SRV0_TIM3_CH1) | \
					 PIN_OSPEED_SPEED_HIGH(SRV1_TIM3_CH2) | \
...
#define VAL_GPIOA_PUPDR                 (PIN_PUPDR_PULLDOWN(AUX3) | \
					 PIN_PUPDR_FLOATING(RC1_UART4_RX) | \
					 PIN_PUPDR_PULLDOWN(AUX2) | \
					 PIN_PUPDR_PULLDOWN(AUX1) | \
					 PIN_PUPDR_FLOATING(VBAT_MEAS) | \
					 PIN_PUPDR_FLOATING(AUX0) | \
					 PIN_PUPDR_FLOATING(SRV0_TIM3_CH1) | \
					 PIN_PUPDR_FLOATING(SRV1_TIM3_CH2) | \
...
#define VAL_GPIOA_ODR                   (PIN_ODR_LEVEL_HIGH(AUX3) | \
					 ...
					 PIN_ODR_LEVEL_LOW(AUX0) | \
					 PIN_ODR_LEVEL_LOW(SRV0_TIM3_CH1) | \
					 PIN_ODR_LEVEL_LOW(SRV1_TIM3_CH2) | \
...
#define VAL_GPIOA_AFRL			(PIN_AFIO_AF(AUX3, 0) | \
					 PIN_AFIO_AF(RC1_UART4_RX, 8) | \
					 PIN_AFIO_AF(AUX2, 0) | \
					 PIN_AFIO_AF(AUX1, 0) | \
					 PIN_AFIO_AF(VBAT_MEAS, 0) | \
					 PIN_AFIO_AF(AUX0, 0) | \
					 PIN_AFIO_AF(SRV0_TIM3_CH1, 2) | \
					 PIN_AFIO_AF(SRV1_TIM3_CH2, 2))
...
#define VAL_GPIOB_MODER                 (PIN_MODE_ALTERNATE(SRV2_TIM3_CH3) | \
					 PIN_MODE_ALTERNATE(SRV3_TIM3_CH4) | \
					 PIN_MODE_INPUT(RC1) | \
...
#define VAL_GPIOB_OTYPER                (PIN_OTYPE_PUSHPULL(SRV2_TIM3_CH3) | \
					 PIN_OTYPE_PUSHPULL(SRV3_TIM3_CH4) | \
...
#define VAL_GPIOB_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(SRV2_TIM3_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(SRV3_TIM3_CH4) | \
...
#define VAL_GPIOB_PUPDR                 (PIN_PUPDR_FLOATING(SRV2_TIM3_CH3) | \
					 PIN_PUPDR_FLOATING(SRV3_TIM3_CH4) | \
...
#define VAL_GPIOB_ODR                   (PIN_ODR_LEVEL_LOW(SRV2_TIM3_CH3) | \
					 PIN_ODR_LEVEL_LOW(SRV3_TIM3_CH4) | \
					 PIN_ODR_LEVEL_LOW(RC1) | \
...
#define VAL_GPIOB_AFRL			(PIN_AFIO_AF(SRV2_TIM3_CH3, 2) | \
					 PIN_AFIO_AF(SRV3_TIM3_CH4, 2) | \
					 PIN_AFIO_AF(RC1, 0) | \
...
#define VAL_GPIOD_MODER                 (PIN_MODE_ALTERNATE(CAN1_RX) | \
					 ...
					 PIN_MODE_ALTERNATE(USART2_CTS) | \
					 PIN_MODE_ALTERNATE(USART2_RTS) | \
					 ...
					 PIN_MODE_ALTERNATE(SRV4_TIM4_CH1) | \
					 PIN_MODE_ALTERNATE(SRV5_TIM4_CH2) | \
					 PIN_MODE_ALTERNATE(SRV6_TIM4_CH3) | \
					 PIN_MODE_ALTERNATE(SRV7_TIM4_CH4))

#define VAL_GPIOD_OTYPER                (PIN_OTYPE_PUSHPULL(CAN1_RX) | \
					 PIN_OTYPE_PUSHPULL(CAN1_TX) | \
					 PIN_OTYPE_PUSHPULL(SDMMC1_CMD) | \
					 PIN_OTYPE_PUSHPULL(USART2_CTS) | \
					 PIN_OTYPE_PUSHPULL(USART2_RTS) | \
					 ...
					 PIN_OTYPE_PUSHPULL(SRV4_TIM4_CH1) | \
					 PIN_OTYPE_PUSHPULL(SRV5_TIM4_CH2) | \
					 PIN_OTYPE_PUSHPULL(SRV6_TIM4_CH3) | \
					 PIN_OTYPE_PUSHPULL(SRV7_TIM4_CH4))

#define VAL_GPIOD_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(CAN1_RX) | \
					 PIN_OSPEED_SPEED_HIGH(CAN1_TX) | \
					 PIN_OSPEED_SPEED_HIGH(SDMMC1_CMD) | \
					 PIN_OSPEED_SPEED_HIGH(USART2_CTS) | \
					 PIN_OSPEED_SPEED_HIGH(USART2_RTS) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(SRV4_TIM4_CH1) | \
					 PIN_OSPEED_SPEED_HIGH(SRV5_TIM4_CH2) | \
					 PIN_OSPEED_SPEED_HIGH(SRV6_TIM4_CH3) | \
					 PIN_OSPEED_SPEED_HIGH(SRV7_TIM4_CH4))

#define VAL_GPIOD_PUPDR                 (PIN_PUPDR_FLOATING(CAN1_RX) | \
					 PIN_PUPDR_FLOATING(CAN1_TX) | \
					 PIN_PUPDR_PULLUP(SDMMC1_CMD) | \
					 PIN_PUPDR_FLOATING(USART2_CTS) | \
					 PIN_PUPDR_FLOATING(USART2_RTS) | \
					 ...
					 PIN_PUPDR_FLOATING(SRV4_TIM4_CH1) | \
					 PIN_PUPDR_FLOATING(SRV5_TIM4_CH2) | \
					 PIN_PUPDR_FLOATING(SRV6_TIM4_CH3) | \
					 PIN_PUPDR_FLOATING(SRV7_TIM4_CH4))
...
#define VAL_GPIOD_ODR                   (PIN_ODR_LEVEL_HIGH(CAN1_RX) | \
					 ...
					 PIN_ODR_LEVEL_LOW(SRV4_TIM4_CH1) | \
					 PIN_ODR_LEVEL_LOW(SRV5_TIM4_CH2) | \
					 PIN_ODR_LEVEL_LOW(SRV6_TIM4_CH3) | \
					 PIN_ODR_LEVEL_LOW(SRV7_TIM4_CH4))

#define VAL_GPIOD_AFRL			(PIN_AFIO_AF(CAN1_RX, 9) | \
					 PIN_AFIO_AF(CAN1_TX, 9) | \
					 PIN_AFIO_AF(SDMMC1_CMD, 12) | \
					 PIN_AFIO_AF(USART2_CTS, 7) | \
					 PIN_AFIO_AF(USART2_RTS, 7) | \
...
#define VAL_GPIOD_AFRH			(PIN_AFIO_AF(USART3_TX, 7) | \
					 ...
					 PIN_AFIO_AF(LED3, 0) | \
					 PIN_AFIO_AF(LED4, 0) | \
					 PIN_AFIO_AF(SRV4_TIM4_CH1, 2) | \
					 PIN_AFIO_AF(SRV5_TIM4_CH2, 2) | \
					 PIN_AFIO_AF(SRV6_TIM4_CH3, 2) | \
					 PIN_AFIO_AF(SRV7_TIM4_CH4, 2))
...
#define VAL_GPIOE_MODER                 (PIN_MODE_ALTERNATE(UART8_RX) | \
					 ...
					 PIN_MODE_ALTERNATE(RC2_UART7_RX) | \
...
#define VAL_GPIOE_OTYPER                (PIN_OTYPE_PUSHPULL(UART8_RX) | \
					 ...
					 PIN_OTYPE_PUSHPULL(RC2_UART7_RX) | \
...
#define VAL_GPIOE_OSPEEDR               (PIN_OSPEED_SPEED_HIGH(UART8_RX) | \
					 ...
					 PIN_OSPEED_SPEED_HIGH(RC2_UART7_RX) | \
...
#define VAL_GPIOE_PUPDR                 (PIN_PUPDR_FLOATING(UART8_RX) | \
					 ...
					 PIN_PUPDR_FLOATING(RC2_UART7_RX) | \
...
#define AF_RC1_UART4_RX                  8U
#define AF_LINE_RC1_UART4_RX             8U
#define AF_SRV0_TIM3_CH1                 2U
#define AF_LINE_SRV0_TIM3_CH1            2U
#define AF_SRV1_TIM3_CH2                 2U
#define AF_LINE_SRV1_TIM3_CH2            2U
...
#define AF_SRV2_TIM3_CH3                 2U
#define AF_LINE_SRV2_TIM3_CH3            2U
#define AF_SRV3_TIM3_CH4                 2U
#define AF_LINE_SRV3_TIM3_CH4            2U
...
#define AF_USART2_CTS                    7U
#define AF_LINE_USART2_CTS               7U
#define AF_USART2_RTS                    7U
#define AF_LINE_USART2_RTS               7U
...
#define AF_SRV4_TIM4_CH1                 2U
#define AF_LINE_SRV4_TIM4_CH1            2U
#define AF_SRV5_TIM4_CH2                 2U
#define AF_LINE_SRV5_TIM4_CH2            2U
#define AF_SRV6_TIM4_CH3                 2U
#define AF_LINE_SRV6_TIM4_CH3            2U
#define AF_SRV7_TIM4_CH4                 2U
#define AF_LINE_SRV7_TIM4_CH4            2U
#define AF_UART8_RX                      8U
#define AF_LINE_UART8_RX                 8U
#define AF_UART8_TX                      8U
#define AF_LINE_UART8_TX                 8U
#define AF_RC2_UART7_RX                  8U
#define AF_LINE_RC2_UART7_RX             8U
